...
```
git clone https://github.com/[your-username]/farmerspot.git
```
...
5. Add a `.env` file in your `/backend` folder and add the below line:
   ...
   ```env
   DATABASE_URL="mongodb://127.0.0.1:27017/farmerspot" # your MongoDB address with port and collection name
   ```
...
8. **(Optional) Seed the database with test accounts:**

```
npm run seed
```

This will create test accounts for all user roles:
- **Admin**: `admin@gmail.com` / `password`
- **Customer**: `customer@gmail.com` / `password`
- **Farmer**: `farmer@gmail.com` / `password`
